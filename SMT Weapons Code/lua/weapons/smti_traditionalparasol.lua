...
SWEP.PrintName = "Traditional Parasol"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A parasol adorned with a simple, yet striking pattern. 40% chance to refresh currently active elemental ailments on an enemy upon hit. \n[CHR 4] 50% chance to refresh currently active elemental ailments on an enemy upon hit."
SWEP.Instructions = ""
