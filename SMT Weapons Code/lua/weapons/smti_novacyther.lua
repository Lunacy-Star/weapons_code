...
SWEP.PrintName = "Nova Cyther"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Tatsuya must have an Almighty-type skill and a Light-type skill to be able to use this ability (Persona skills applicable). Tatsuya hits all enemies twice, dealing 30 Almighty damage in the first hit and 30 Light damage in the second. The first and second hit have a chance of granting Tatsuya Tarukaja on a (Luck + STR)%"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        if almightyFound and lightFound then
            ...
            if next(targetedTargets) == nil then
                ...
                for _, ent in pairs(targetedTargets) do
                    ...
                    for i = 1, 2 do
                        ...
                        local tarukajaChance = math.ceil(playerLuck + playerStr)
                        ...
                        if math.random(1, 100) <= tarukajaChance then
                            ...
                            AssignStat(targetEffects["ply"], "Tarukaja",
                                       userBuffsTable["Tarukaja"], "buffs")

                            self:AnnounceMessage(
                                targetEffects["ply"]:Name() ..
                                    " received Tarukaja! They now have " ..
            ...
            ply:ChatPrint(
                "You can't use this skill without an Almighty and Light skill!")
        end
    end
    ply:LagCompensation(false)
end --
