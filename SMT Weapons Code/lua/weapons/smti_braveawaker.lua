...
SWEP.PrintName = "Brave Awaker"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Your courage rises mysteriously when you hold the tonfa with the will of protecting others. After attacking with this weapon, select 1 ally or self and remove 1 Rakunda. Automatically enter Guard state after use. \n[STR 6] The user receives +1 Rakukaja after using the weapon."
SWEP.Instructions = ""
