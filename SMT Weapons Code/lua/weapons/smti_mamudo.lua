...
SWEP.PrintName = "Mamudo"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "52 dark damage (all enemies). The following conditions trigger instakill based on percent value and add onto each other: Marked with Cursed: 3% [CHR 6] Marked with Cursed chance is 4% instead."
SWEP.Instructions = ""
