...
SWEP.PrintName = "Lullaby"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "30 ruin damage (all enemies). 20% chance to inflict Sleep. \n[CHR 4] 25% chance to inflict Sleep instead."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if math.random(1, 100) <= targetEffects["ailmentChance"] then
                    ...
                    AssignStat(targetEffects["target"], "Sleep",
                               debuffsTable["Sleep"], "debuffs")

                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now Asleep!")
