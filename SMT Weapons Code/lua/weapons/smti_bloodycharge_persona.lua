...
SWEP.PrintName = "Bloody Charge (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Increases next physical attack's damage by 1.6x. Includes damage increased through Tarukaja. Also increases bonus critical chance by 20% for the next physical attack."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Bloody_Charge"] = {stacks = 1}

            AssignStat(target, "Bloody_Charge", targetBuffsTable["Bloody_Charge"],
                       "buffs")
