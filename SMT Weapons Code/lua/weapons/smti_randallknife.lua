...
SWEP.PrintName = "Randall Knife"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A sharp knife with a good grip. Sturdier than it looks, its blade will never grow dull. +1 Luck"
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_randallknife.png"
...
function SWEP:DropFunction()
    if SERVER and IsValid(self.Owner) then
        ...
        self.Owner:SetNWInt("TBCLuck", playerLuck - 1) -- Ensuring it doesn't go below the default value
    end
end
