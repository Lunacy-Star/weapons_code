...
SWEP.PrintName = "Static Rook Anaguma"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Rakukaja and Sukukaja +1 to all allies."
SWEP.Instructions = ""
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                if IsValid(player) then -- Check if the player is valid
                    ...
                    AssignStat(player, "Rakukaja", buffsTable["Rakukaja"],
                               "buffs")
                    ...
                    local message = player:Name() ..
                                        " received Rakukaja and Sukukaja from " ..
