...
SWEP.PrintName = "Quick Tarukaja"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Gain Tarukaja +1 for self."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER and IsValid(ply) then
        ...
        local message = ply:Name() .. " received Tarukaja! They now have " ..
                            userBuffsTable["Tarukaja"].stacks .. " stacks!"
