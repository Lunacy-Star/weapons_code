...
SWEP.PrintName = "Fire Break (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Fire affinity of a target to Weak. Only works on targets who are not Weak to Fire and lasts for 2 turns. Fire Break is not considered an ailment but can be dispelled with Fire Wall."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            if not (table.HasValue(weak, "Fire") or
                ...
                targetDebuffsTable["Fire_Break"] = {stacks = 1, duration = 2}

                AssignStat(target, "Fire_Break", targetDebuffsTable["Fire_Break"],
                           "debuffs")
