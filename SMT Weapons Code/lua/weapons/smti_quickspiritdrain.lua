...
SWEP.PrintName = "Quick Spirit Drain"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Deals 15 Almighty damage on target and regenerates 15 MP."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local healerMP = ply:GetNWInt("TBCMP", 100)
            local healerMaxMP = ply:GetNWInt("TBCMAXMP", 100)
            healerMP = math.min(healerMP + self.RegenAmount, healerMaxMP)
            ply:SetNWInt("TBCMP", healerMP)
            ply:ChatPrint("You recover " .. self.RegenAmount ..
                              " MP from Quick Spirit Drain!")
