...
SWEP.PrintName = "Tetraja (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Nullifies one incoming insta-kill effect. Wears off automatically after 3 turns. Cannot stack."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Tetraja"] = {stacks = 1, duration = 3}

            AssignStat(target, "Tetraja", targetBuffsTable["Tetraja"], "buffs")
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        targetBuffsTable["Tetraja"] = {stacks = 1, duration = 4}
