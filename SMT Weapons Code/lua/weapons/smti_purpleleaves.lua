...
SWEP.PrintName = "Purple Leaves"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Whenever Tomoko deals damage with Ruin attacks or is hit by Ruin attacks, she gains +1 Purple Leaves (Ruin Rush is applicable to this effect). At 4 Leaves, this spell can be cast to heal an ally for 15% of their max HP and grant +2 Tarukaja."
SWEP.Instructions = ""
