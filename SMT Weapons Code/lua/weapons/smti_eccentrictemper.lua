...
SWEP.PrintName = "Eccentric Temper"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 10 Phys damage to all enemies. This damage is amped up by 5 per Tarukaja stack on Ryuji."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if targetEffects["userBuffsTable"]["Tarukaja"] then
                    targetEffects["baseDamage"] =
                        targetEffects["baseDamage"] +
                            (5 *
                                targetEffects["userBuffsTable"]["Tarukaja"]["stacks"])
                end
