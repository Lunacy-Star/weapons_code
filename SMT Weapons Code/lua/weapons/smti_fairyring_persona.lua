...
SWEP.PrintName = "Fairy Ring (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "40 ruin damage to all enemies. 25% chance to inflict Charm. \n[CHR 4] 30% chance to inflict Charm instead."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if math.random(1, 100) <= targetEffects["ailmentChance"] then
                    ...
                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now Charmed!")
