...
SWEP.PrintName = "Agilao (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "60 fire damage to a single target. 10% chance to inflict Burn. [STR 4] MP Cost reduced to 10 MP. [CHR 4] 20% chance to inflict Burn."
SWEP.Instructions = ""
