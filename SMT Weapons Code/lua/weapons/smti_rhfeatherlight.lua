...
SWEP.PrintName = "RH Featherlight"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "As its name implies, this is a gun made with lightness and usability in mind. +3 Luck."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Ranged Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_rhfeatherlight.png"
...
function SWEP:Equip(ply)
    if SERVER then
        timer.Create(ply:Name() .. self.PrintName, 0.2, 1, function()
            local playerLuck = ply:GetNWInt("TBCLuck", 10)
            ply:SetNWInt("TBCLuck", playerLuck + 3)
        end)
    end
end
