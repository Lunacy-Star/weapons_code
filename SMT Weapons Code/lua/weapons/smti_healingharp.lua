...
SWEP.PrintName = "Healing Harp"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Restores HP of all allies by 35% of their Max HP. Gives Rakukaja +1 and Lydia to all allies."
SWEP.Instructions = ""
                ...
                for _, target in ipairs(playersInFight) do
                    if IsValid(target) then -- Check if the player is valid
                        ...
                        if currentHP > 0 then
                            ...
                            AssignStat(target, "Rakukaja",
                                       targetBuffsTable["Rakukaja"], "buffs")
