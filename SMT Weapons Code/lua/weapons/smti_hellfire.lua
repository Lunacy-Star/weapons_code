...
SWEP.PrintName = "Hellfire"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Hits 3-5 times on random foes. 26 fire damage for the first hit, but every subsequent hit deals 5 less damage than the last. \n[STR 6] 28 fire damage for first hit instead. \n[CHR 6] Every subsequent hit deals 4 less damage instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            if playerStr >= 6 then self.DamageAmount = 28 end

            local lowerDamage = 5
            if playerChr >= 6 then lowerDamage = 4 end
