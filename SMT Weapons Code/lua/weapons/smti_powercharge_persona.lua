...
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Increases next physical attack's total damage by 1.25x of an ally or self."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Power_Charge"] = {stacks = 1}

            AssignStat(target, "Power_Charge", targetBuffsTable["Power_Charge"],
                       "buffs")
