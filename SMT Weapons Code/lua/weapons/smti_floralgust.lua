            ...
            for i = 1, loopIterations do
                ...
                if math.random(1, 100) <= targetEffects["ailmentChance"] then
                    ...
                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now Confused!")

                    debuffsTable["Confusion"] = {stacks = 1, duration = 3}

                    AssignStat(targetEffects["target"], "Confusion",
                               debuffsTable["Confusion"], "debuffs")
