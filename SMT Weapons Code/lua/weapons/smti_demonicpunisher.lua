...
SWEP.PrintName = "Demonic Punisher"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "It's simple to use. First load it with a bullet then pull the trigger. You're rewarded to look at the grotesque bullet mark. If target has less than 50% of their Max HP left, damage increased to 60. \n[STR 6] Effect damage increased to 64."
SWEP.Instructions = ""
