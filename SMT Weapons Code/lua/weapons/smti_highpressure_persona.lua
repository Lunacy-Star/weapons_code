...
SWEP.PrintName = "High Pressure (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "30 ruin damage (all enemies). 20% chance to inflict Panic. \n[CHR 4] 25% chance to inflict Panic instead."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if math.random(1, 100) <= targetEffects["ailmentChance"] then
                    ...
                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now Panicking!")
