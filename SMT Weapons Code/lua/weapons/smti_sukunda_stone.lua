...
SWEP.PrintName = "Sukunda Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone that increases -nda debuff properties of a user. Decreases Sukukaja count by -1. Every Sukunda decreases Technique by 10. Minimum Sukukaja count = -4."
SWEP.Instructions = ""
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        if targetEffects["targetDebuffsTable"]["Sukunda"] then
            targetEffects["targetDebuffsTable"]["Sukunda"].stacks = math.min(
                                                                        targetEffects["targetDebuffsTable"]["Sukunda"]
                                                                            .stacks +
                                                                            1, 4)
        else
        ...
        local message =
            target:Name() .. " received Sukunda from " .. ply:Name() ..
                "! They now have " ..
                targetEffects["targetDebuffsTable"]["Sukunda"].stacks ..
                " stacks!"
