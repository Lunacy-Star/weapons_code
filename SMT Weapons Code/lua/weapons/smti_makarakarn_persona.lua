...
SWEP.PrintName = "Makarakarn (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Makarakarn"] = {stacks = 1, duration = 3}

            AssignStat(target, "Makarakarn", targetBuffsTable["Makarakarn"],
                       "buffs")
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        targetBuffsTable["Makarakarn"] = {stacks = 1, duration = 4}

        AssignStat(target, "Makarakarn", targetBuffsTable["Makarakarn"], "buffs")
