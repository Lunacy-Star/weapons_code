...
SWEP.PrintName = "Phoenix's Gust"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 10 Fire damage to all enemies. If one of the enemies she is targeting is inflicted with the burn ailment, that enemy receives -1 Rakukaja stack."
SWEP.Instructions = ""
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if targetEffects["targetDebuffsTable"]["Burn"] then
