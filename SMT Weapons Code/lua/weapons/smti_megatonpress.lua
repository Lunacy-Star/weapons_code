...
SWEP.PrintName = "Megaton Press"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 45 martial art damage (all enemies). Having a Martial Art weapon equipped also lets the skill have 10%+ Bonus Crit Chance. \n[STR 6] HP Cost reduced to 16 HP. \n[DEX 6] Bonus Crit Chance 12%+ on effect."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerStr >= 6 then hpCost = 16 end
                ...
                for _, weapon in pairs(ply:GetWeapons()) do
                    if weapon.WeaponType then
                        if "Martial Arts" == weapon.WeaponType then
                            ...
                            local playerDex =
                                tonumber(ply:GetNWInt("TBCDEX", 0))
                            if playerDex >= 6 then
