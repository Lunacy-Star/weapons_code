...
SWEP.PrintName = "Iwakura Water"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Crystal clear water that helps cure certain ailments upon physical application. Ammo Stack = 3. Effect: Removes Sleep, Mute, and Taunt."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local debuffsToRemove = {"Sleep", "Mute", "Taunt", "Lydia"}
