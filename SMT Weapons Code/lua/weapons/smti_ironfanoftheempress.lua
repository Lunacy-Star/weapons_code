...
SWEP.PrintName = "Iron Fan of the Empress"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A long time ago, a demon owned this flame-red metal fan. The magical power imbued in it helps aid in the incantation magic. Heals back 10 HP from damage caused by Fire. \n[STR 6] Weapon damage is calculated as Fire instead of Blade. \n[CHR 6] Regeneration effect increased to 15 HP, and additionally regenerates 2 MP."
SWEP.Instructions = ""
...
SWEP.BuffType = "buffs"
SWEP.BuffName = "Iron_Fan_of_the_Empress"
