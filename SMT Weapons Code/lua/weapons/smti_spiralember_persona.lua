...
SWEP.PrintName = "Spiral Ember (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "40 fire damage (all enemies). 50% chance to reduce Rakukaja by -1."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if math.random(1, 100) <= 50 then
                    ...
                    if targetDebuffsTable["Rakunda"] then
                        targetDebuffsTable["Rakunda"].stacks = math.min(
                                                                    targetDebuffsTable["Rakunda"]
                                                                        .stacks +
                                                                        1, 4)
                    else
