...
SWEP.PrintName = "Double Shot"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "User fires twice, hitting enemies randomly up to 2 times. Each hit deals 42 gun damage. \n[STR 3 + DEX 4] 5 Technique."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit then
        if SERVER then
            ...
            if playerStr >= 3 and playerDex >= 4 then tech = 5 end
