...
SWEP.PrintName = "Heal Boost"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Target receives increased healing from all sources by 25%. Heal Dampener and Dekaja cancels this."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Heal_Boost"] = {stacks = 1}

            AssignStat(target, "Heal_Boost", targetBuffsTable["Heal_Boost"],
                       "buffs")
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        AssignStat(target, "Heal_Boost", targetBuffsTable["Heal_Boost"], "buffs")

        local message = ply:Name() .. " received " .. self.PrintName .. "!"
        self:AnnounceMessage(message)
