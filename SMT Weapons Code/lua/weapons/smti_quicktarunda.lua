...
SWEP.PrintName = "Quick Tarunda"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "+1 Tarunda on a target."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetDebuffsTable["Tarunda"] then
                targetDebuffsTable["Tarunda"].stacks = math.min(
                                                           targetDebuffsTable["Tarunda"]
                                                               .stacks + 1, 4)
            else
                targetDebuffsTable["Tarunda"] = {stacks = 1}
            end

            AssignStat(target, "Tarunda", targetDebuffsTable["Tarunda"],
                       "debuffs")
            ...
            local message = target:Name() .. " received " .. self.PrintName ..
                                ...
                                targetDebuffsTable["Tarunda"].stacks ..
                                " stacks!"
