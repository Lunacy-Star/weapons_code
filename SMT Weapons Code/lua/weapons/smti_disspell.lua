...
SWEP.PrintName = "Dis-Spell"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Also known as Dis-Close. A smooth stone that shatters when curing a target of certain ailments. Ammo Stack = 3. Removes Charm, Paralyze and Poison."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local debuffsToRemove = {"Charm", "Paralysis", "Poison", "Lydia"}
            ...
            local message =
                target:Name() .. " received Dispell " .. ply:Name() .. "!"
...
function SWEP:SecondaryAttack()
    ...
    if ply:IsPlayer() then
        ...
        if SERVER and IsValid(target) then
            ...
            local message = target:Name() .. " received Dispell from " ..
                                ply:Name() .. "!"
