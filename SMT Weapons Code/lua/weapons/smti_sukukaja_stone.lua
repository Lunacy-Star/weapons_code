...
SWEP.PrintName = "Sukukaja Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone that boosts -kaja buff properties of a user. Increases Sukukaja count by +1. Every Sukukaja increases overall Technique by 10. Maximum Sukukaja count = +4."
SWEP.Instructions = ""
