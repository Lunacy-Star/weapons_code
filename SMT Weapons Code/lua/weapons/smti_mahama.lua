...
SWEP.PrintName = "Mahama"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "52 light damage (all enemies). The following conditions trigger instakill based on percent value and add onto each other: Marked with Judgement: 3% [CHR 6] Marked with Judgement chance is 4% instead."
SWEP.Instructions = ""
