...
SWEP.PrintName = "Headhunter's Spoon"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A cursed weapon with a device for cutting the heads of enemies installed at the tip. The wielder gains considerable power by sacrificing their own body. Receive 5 HP damage every use. Bonus Crit Chance 30%."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if attackerHP >= hpCost then
                ...
                ply:ChatPrint("Not enough HP to use this weapon.")
                ply:LagCompensation(false)
                return
            end
