...
SWEP.PrintName = "Intercontinental Ballistic Missile"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Launch a condensed ICBM directly into an enemy party, dealing 150 almighty damage."
SWEP.Instructions = ""
SWEP.Category = "SMT Odd Skills"
