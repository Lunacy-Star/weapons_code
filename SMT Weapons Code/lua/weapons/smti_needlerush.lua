...
SWEP.PrintName = "Needle Rush"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 48 throw damage on a single target. \n[DEX 3 + CHR 4] 54 throw damage."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 3 and playerChr >= 4 then
                targetEffects["baseDamage"] = 54
            end
