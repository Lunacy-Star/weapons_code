...
SWEP.PrintName = "Glacial Blast"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Caster deals 50 ice damage to self but gains +1 Rakukaja after the attack and deals 130% of the damage they received on all enemy targets. \n[STR 7]  Gains +2 Rakukaja instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            local buffStacks = 1
            if playerStr >= 7 then buffStacks = 2 end
            ...
            if userBuffsTable["Rakukaja"] then
                ...
                userBuffsTable["Rakukaja"] = {stacks = buffStacks}
            end

            AssignStat(ply, "Rakukaja", userBuffsTable["Rakukaja"], "buffs")

            self:AnnounceMessage(ply:Name() .. " received " .. buffStacks ..
                                     " Rakukaja stacks! They now have " ..
