...
SWEP.Contact = ""
SWEP.Purpose =
    "45 Gun damage to a single target. 30% chance to inflict Sleep. \n[STR 6] MP Cost reduced to 12 MP. \n[CHR 6] 35% chance to inflict Sleep."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 6 then mpCost = 12 end
            ...
            if playerChr >= 6 then
                targetEffects["ailmentChance"] = 35
            end
