...
SWEP.PrintName = "Riot Gun"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 70 gun damage (all enemies). \n[STR 6] HP Cost reduced to 24 HP. \n[CHR 4] Bonus Crit Chance 5%+"
SWEP.Instructions = ""
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                local critBonus = 0
                if playerChr >= 4 then critBonus = critBonus + 5 end
