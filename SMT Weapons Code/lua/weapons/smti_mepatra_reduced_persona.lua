...
SWEP.PrintName = "Me Patra (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Remove Rage/Panic/Mute/Sleep from all party members."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            local debuffsToRemove = {"Rage", "Panic", "Mute", "Sleep"}
            ...
            for _, player in ipairs(playersInFight) do
                ...
                local message = player:Name() .. " received Me Patra from " ..
                                    ply:Name() .. "!"
