...
SWEP.PrintName = "Lourdes (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Cures poison/paralysis/freeze for 1 ally."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local debuffsToRemove = {"Poison", "Paralysis", "Freeze", "Lydia"}
            ...
            local message = target:Name() .. " received Lourdes from " ..
                                ply:Name() .. "!"
