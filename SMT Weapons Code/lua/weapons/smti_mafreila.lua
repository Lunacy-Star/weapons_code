...
SWEP.PrintName = "Mafreila"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "52 nuke damage (all enemies). If hitting an enemy inflicted by Burn/Freeze/Shock/Confusion, 20% bonus crit chance. \n[CHR 4] MP Cost reduced to 24 MP. \n[DEX 4] Bonus crit chance effect is 25% instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerChr >= 4 then mpCost = 24 end
