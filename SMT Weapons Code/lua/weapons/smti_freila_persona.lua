...
SWEP.PrintName = "Freila (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "60 nuke damage to a single target. [STR 3 + DEX 3] If hitting an enemy inflicted by Burn, Freeze, Shock, or Confusion, Bonus Crit Chance 20%+."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 3 and playerDex >= 3 then
                if targetEffects["targetDebuffsTable"]["Burn"] or
                    ...
                    targetEffects["critChance"] = targetEffects["critChance"] +
                                                       20
                end
            end
