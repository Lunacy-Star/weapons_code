...
SWEP.PrintName = "Steelslicer"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A longsword shaped like a chainsaw with the power to split a steel helmet. Difficult to obtain and maintain. Every Tarukaja on the wielder reduces this weapon's Technique by -5. \n[STR 7] Penalty is -1 instead."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_steelslicer.png"
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if userBuffsTable["Tarukaja"] then
                ...
                if playerStr >= 7 then
                    tech = tech - (1 * userBuffsTable["Tarukaja"]["stacks"])
                else
                    tech = tech - (5 * userBuffsTable["Tarukaja"]["stacks"])
                end
            end
