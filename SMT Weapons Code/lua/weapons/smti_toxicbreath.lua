...
SWEP.PrintName = "Toxic Breath"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "[Hydra] [Dark] [Phase 2: 80% of Max HP or lower]\nDeals 60 Dark attack to all enemies. 25% chance of inflicting Poison. Poison inflict chance increases to 40% if enemy is weak to Dark."
SWEP.Instructions = ""
...
SWEP.PoisonChance = 25
SWEP.PoisonChanceWeak = 40
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if currentSelfHP > maxSelfHP * self.PhaseThreshold then
            ply:ChatPrint("Toxic Breath is not available yet.")
            ply:LagCompensation(false)
            return
        end
