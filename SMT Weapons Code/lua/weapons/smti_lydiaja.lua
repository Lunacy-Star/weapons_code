...
SWEP.PrintName = "Lydiaja"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Applies Lydia on a single target."
SWEP.Instructions = ""
SWEP.Category = "SMT Support Skills"
SWEP.SpawnMenuIcon = "materials/entities/smti_lydiaja.png"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            AssignStat(target, "Lydia", targetBuffsTable["Lydia"], "buffs")

            local message = target:Name() .. " received Lydia from " ..
                                ply:Name() .. "!"
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        local message = target:Name() .. " received Lydia!"
