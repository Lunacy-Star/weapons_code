...
SWEP.PrintName = "Hades Blast"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 75 physical damage (all enemies). \n[STR 6] HP Cost reduced to 26 HP. \n[DEX 6] Bonus Crit Chance 5%+"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerStr >= 6 then hpCost = 26 end
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                local critBonus = 0
                if playerDex >= 6 then critBonus = critBonus + 5 end
