...
SWEP.PrintName = "Mail Order Axe"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "An ordinary wood axe sold through mail-order. +1 Luck."
SWEP.Instructions = ""
...
SWEP.ViewModel = "models/weapons/smti_ax1_v.mdl" -- Viewmodel path
