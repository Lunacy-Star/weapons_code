...
SWEP.PrintName = "Two-Handed Sword"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A huge longsword wielded with both hands. Not sold in ordinary shops."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_twohandedsword.png"
