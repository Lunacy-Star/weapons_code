...
SWEP.PrintName = "Agony Mantis"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A simple weapon composed of a heavy block of metal attached at the tip of a rod. 25% chance to inflict Panic on hit."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_agonymantis.png"
