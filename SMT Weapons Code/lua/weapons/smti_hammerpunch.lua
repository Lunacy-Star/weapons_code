...
SWEP.PrintName = "Hammer Punch"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 72 martial art damage on a single target. \n[STR 6] 10% Bonus Crit Chance [DEX 6] 5 Technique."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local critBonus = 0
            if playerStr >= 6 then critBonus = critBonus + 10 end
