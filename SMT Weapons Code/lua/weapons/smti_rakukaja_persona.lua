...
SWEP.PrintName = "Rakukaja (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Increases Rakukaja count by +1. Every Rakukaja decreases received damage by 0.2x. Maximum Rakukaja count = +4."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetBuffsTable["Rakukaja_Agathion"] then
                targetBuffsTable["Rakukaja_Agathion"].stacks = math.min(
                                                          targetBuffsTable["Rakukaja_Agathion"]
                                                              .stacks + 1, 4)
            else
                targetBuffsTable["Rakukaja_Agathion"] = {stacks = 1}
            end

            AssignStat(target, "Rakukaja_Agathion",
                       targetBuffsTable["Rakukaja_Agathion"], "buffs")

            local message = target:Name() .. " received Rakukaja! They now have " ..
                                targetBuffsTable["Rakukaja_Agathion"].stacks ..
                                " stacks!"
