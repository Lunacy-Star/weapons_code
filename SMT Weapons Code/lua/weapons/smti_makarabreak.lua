...
SWEP.PrintName = "Makara Break"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Removes Makarakarn from target if applicable."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if buffsTable["Makarakarn"] then
                RemoveStat(target, "Makarakarn", "buffs")
                buffsTable["Makarakarn"] = nil
                message = target:Name() .. "'s Makarakarn is broken apart!"
            end
