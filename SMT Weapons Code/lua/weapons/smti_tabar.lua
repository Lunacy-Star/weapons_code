...
SWEP.PrintName = "Tabar"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "An ancient battle axe with an unusual double-edge crescent blade. Even the handle is made of metal, giving it huge destructive power. Bonus damage by additive STR value"
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_tabar.png"
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr > 0 then
                targetEffects["baseDamage"] =
                    targetEffects["baseDamage"] + playerStr
            end
            ...
            targetEffects["message"] = target:Name() .. " received " ..
                                           targetEffects["baseDamage"] ..
                                           " damage."
