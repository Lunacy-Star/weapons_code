...
SWEP.PrintName = "Onyx Grimoire"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "This grimoire holds a power promising further destructive mastery over incantations. Boosts all Dark damage from wielder by 10. \n[STR 6] Weapon damage is calculated as Dark instead of Blunt. \n[CHR 6] Dark damage boost increased to 15."
SWEP.Instructions = ""
