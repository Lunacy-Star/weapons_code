...
SWEP.PrintName = "Compound Crossbow"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A bow using a locking mechanism that requires good strength to reap the benefits of its quiet precision. Technique increases based on additive STR value."
SWEP.Instructions = ""
