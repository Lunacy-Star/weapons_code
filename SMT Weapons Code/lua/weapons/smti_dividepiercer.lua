...
SWEP.PrintName = "Divide Piercer"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A sword designed for accurately hitting an opponent's weak spot. Its needle-like blade hides the fact it can easily pierce a thin sheet of metal. Damage is 60 VS targets weak to Phys/Blade [STR 3 + DEX 5] Bonus Crit Chance 10%+"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 3 and playerDex >= 5 then
