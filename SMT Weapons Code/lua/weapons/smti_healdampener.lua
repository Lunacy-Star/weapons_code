...
SWEP.PrintName = "Heal Dampener"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Target receives reduced healing from all sources by 25%. Heal Boost and Dekunda cancels this."
SWEP.Instructions = ""
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        AssignStat(target, "Heal_Dampener", targetDebuffsTable["Heal_Dampener"],
                   "debuffs")
