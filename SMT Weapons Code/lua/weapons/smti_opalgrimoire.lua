...
SWEP.PrintName = "Opal Grimoire"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "This grimoire holds a power promising further destructive mastery over incantations. Boosts all Nuke damage from wielder by 10. \n[STR 6] Weapon damage is calculated as Nuke instead of Blunt. \n[CHR 6] Nuke damage boost increased to 15."
SWEP.Instructions = ""
