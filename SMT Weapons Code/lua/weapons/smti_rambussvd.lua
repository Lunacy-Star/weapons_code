...
SWEP.PrintName = "Rambus SVD"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A sniper rifle with steady aim designed by the gunmaker Dragunov. \n[CHR 3] Bonus Crit Chance: DEX + CHR%"
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Ranged Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_rambussvd.png"
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerChr >= 3 then
                ...
                critBonus = critBonus + (playerDex + playerChr)
            end
