...
SWEP.PrintName = "Lightning Smash"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 60 blunt damage on a single target. 25% chance to inflict Shock on hit. \n[STR 6] 64 blunt damage."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 6 then targetEffects["baseDamage"] = 64 end
