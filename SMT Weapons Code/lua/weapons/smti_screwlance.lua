...
SWEP.PrintName = "Screw Lance"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A heavy mechanical lance created from a drill used for digging into the bedrock. Although it can pierce an enemy's armor and drill into its flesh, its weight makes it difficult for most people to use. Successful attacks inflict 1 Rakunda. \n[STR 6] Guarding self-applies 1 Rakukaja."
SWEP.Instructions = ""
...
SWEP.Affinity = "Blade"
SWEP.Targets = "single"
SWEP.WeaponType = "Blade"
SWEP.SlotsTaking = 1
SWEP.SlotType = "Equipment"
SWEP.BuffType = "buffs"
SWEP.BuffName = "Screw_Lance"
