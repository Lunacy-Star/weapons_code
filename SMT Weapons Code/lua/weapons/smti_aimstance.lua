...
SWEP.PrintName = "Aim Stance"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "For three turns, attacks with a ranged/pierce weapon have +15 technique. Moreover, any ranged attack made by Naoto while in this stance apply cursed."
SWEP.Instructions = ""
SWEP.Category = "SMT Support Skills"
SWEP.SpawnMenuIcon = "materials/entities/smti_aimstance.png"
...
function SWEP:PrimaryAttack()
    ...
    if ply:IsPlayer() then
        ...
        if SERVER and IsValid(target) then
            ...
            userBuffsTable["Aim_Stance"] = {stacks = 1, duration = 4}

            AssignStat(ply, "Aim_Stance", userBuffsTable["Aim_Stance"], "buffs")

            local message = ply:Name() .. " takes aim!"
