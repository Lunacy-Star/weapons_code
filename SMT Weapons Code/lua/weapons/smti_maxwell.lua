...
SWEP.Contact = ""
SWEP.Purpose =
    "An item that speaks in a mysterious space language... Heals back 10 HP from damage caused by Elec. \n[DEX 6] Weapon damage is calculated as Elec instead of Blade. \n[CHR 6] Regeneration effect increased to 15 HP, and additionally regenerates 2 MP."
SWEP.Instructions = ""
