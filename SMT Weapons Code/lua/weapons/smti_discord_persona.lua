...
SWEP.PrintName = "Discord (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Removes active Power Charges and Mind Charges from enemy team."
SWEP.Instructions = ""
...
local buffsToRemove = {"Power_Charge", "Mind_Charge"}
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                if IsValid(player) then -- Check if the player is valid
                    ...
                    local message = player:Name() .. " received Discord from " ..
                                        ply:Name() .. "!"
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                if IsValid(player) then -- Check if the player is valid
                    ...
                    local message = player:Nick() .. " received Discord from " ..
                                        ply:Name() .. "!"
