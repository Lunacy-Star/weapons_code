...
SWEP.PrintName = "Force Wall (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Force affinity of an ally to Resist. Only works on allies who do not resist or are weak to Force and lasts against 1 attack. If used on a target who is inflicted by Force Break, dispel Force Break and restore their affinity instead."
SWEP.Instructions = ""
