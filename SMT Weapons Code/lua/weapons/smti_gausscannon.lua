...
SWEP.Contact = ""
SWEP.Purpose =
    "A rifle that uses electromagnetic power to fire its bullets. An inbuilt condenser allows for phased acceleration that delivers huge amounts of of damage. Every Sukukaja on the wielder buffs the damage by 5."
SWEP.Instructions = ""
