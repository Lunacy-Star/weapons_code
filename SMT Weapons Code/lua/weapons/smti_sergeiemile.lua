...
SWEP.PrintName = "Sergei Emile"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A rifle that has been used in many great battles. \n[STR 4] Ignores Resist Phys."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Ranged Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_sergeiemile.png"
