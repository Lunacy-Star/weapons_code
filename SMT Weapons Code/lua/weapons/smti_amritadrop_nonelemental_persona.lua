...
SWEP.PrintName = "Amrita Drop (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Cures an ally of non-elemental ailments."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            local debuffsToRemove = Ailments_Statuses["Non_Elemental_Ailments"]
            ...
            local message = target:Name() .. " received Amrita Drop from " ..
                                ply:Name() .. "!"
