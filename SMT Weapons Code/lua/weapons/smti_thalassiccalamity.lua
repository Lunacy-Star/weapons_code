...
SWEP.PrintName = "Thalassic Calamity"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Causes a storm of ice for 70 Ice damage on all enemies. Luck + DEX% chance to inflict Freeze."
SWEP.Instructions = ""
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                targetEffects["ailmentChance"] = playerDex + playerLuck
