...
SWEP.PrintName = "Clown Mace"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A mace that belonged to a jester who was skilled in magic and conversation. +1 damage for every Magic-type spell in possession."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            for _, weapon in pairs(ply:GetWeapons()) do
                if weapon.WeaponType and weapon.WeaponType == "Magic Skill" then
