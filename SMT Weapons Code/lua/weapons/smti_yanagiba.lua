...
SWEP.PrintName = "Yanagiba"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A katana with a long, curved blade like that of a willow leaf. \n[STR 6] Damage: 50. \n[DEX 6] Technique: 30. \n[CHR 6] Bonus Crit Chance: 10%+."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_yanagiba.png"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 6 then tech = 30 end
            ...
            if playerStr >= 6 then targetEffects["baseDamage"] = 50 end
