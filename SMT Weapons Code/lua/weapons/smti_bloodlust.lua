...
SWEP.PrintName = "Bloodlust"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Tarukaja and Sukukaja +1 to all allies."
SWEP.Instructions = ""
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                if IsValid(player) then -- Check if the player is valid
                    ...
                    AssignStat(player, "Sukukaja", buffsTable["Sukukaja"],
                               "buffs")
                    ...
                    local message = player:Name() ..
                                        " received Tarukaja and Sukukaja from " ..
                                        ply:Name() .. "! They now have " ..
                                        buffsTable["Tarukaja"].stacks ..
                                        " Tarukaja and " ..
                                        buffsTable["Sukukaja"].stacks ..
                                        " Sukukaja!"
