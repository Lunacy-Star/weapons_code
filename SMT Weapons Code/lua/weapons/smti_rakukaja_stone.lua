...
SWEP.PrintName = "Rakukaja Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone that boosts -kaja buff properties of a user. Increases Rakukaja count by +1. Every Rakukaja decreases received damage by 0.1x. Maximum Rakukaja count = +4."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local message = target:Name() .. " received Rakukaja from " ..
