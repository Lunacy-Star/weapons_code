...
SWEP.PrintName = "Tarukaja Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone that boosts -kaja buff properties of a user. Increases Tarukaja count by +1. Every Tarukaja increases damage dealt by 0.1x. Maximum Tarukaja count = +4."
SWEP.Instructions = ""
