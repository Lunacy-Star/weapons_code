...
SWEP.PrintName = "Fan of Hypnosis"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A demon once spun this fan to bend the will of mankind to their favor. Its hypnotic power lays dormant, yet alluring to those who see it. Heals back 10 HP from damage caused by Ruin. \n[STR 6] Weapon damage is calculated as Ruin instead of Blunt. \n[CHR 6] Regeneration effect increased to 15 HP, and additionally regenerates 2 MP."
SWEP.Instructions = ""
