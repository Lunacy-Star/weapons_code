...
SWEP.PrintName = "Tetra Break"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Removes Tetrakarn from target if applicable."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            if buffsTable["Tetrakarn"] then
                RemoveStat(target, "Tetrakarn", "buffs")
                buffsTable["Tetrakarn"] = nil
                message = target:Name() .. "'s Tetrakarn is broken apart!"
            end
