...
SWEP.PrintName = "Elec Break (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Elec affinity of a target to Weak. Only works on targets who are not Weak to Elec and lasts for 2 turns. Elec Break is not considered an ailment but can be dispelled with Elec Wall."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if not (table.HasValue(weak, "Elec") or
                ...
                targetDebuffsTable["Elec_Break"] = {stacks = 1, duration = 2}

                AssignStat(target, "Elec_Break", targetDebuffsTable["Elec_Break"],
                           "debuffs")
