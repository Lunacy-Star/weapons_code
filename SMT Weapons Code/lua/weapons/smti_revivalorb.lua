...
SWEP.PrintName = "Revival Orb"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "An orb that revitalizes users in danger. Ammo Stack = 2. Effect: Revives a target with 15% of their Max HP restored."
SWEP.Instructions = ""
