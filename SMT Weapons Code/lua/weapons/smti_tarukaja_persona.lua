...
SWEP.PrintName = "Tarukaja (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Increases Tarukaja count by +1. Every Tarukaja increases damage dealt by 0.2x. Maximum Tarukaja count = +4."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetBuffsTable["Tarukaja_Inugami"] then
                targetBuffsTable["Tarukaja_Inugami"].stacks = math.min(
                                                          targetBuffsTable["Tarukaja_Inugami"]
                                                              .stacks + 1, 4)
            else
                targetBuffsTable["Tarukaja_Inugami"] = {stacks = 1}
            end

            AssignStat(target, "Tarukaja_Inugami",
                       targetBuffsTable["Tarukaja_Inugami"], "buffs")

            local message = target:Name() .. " received Tarukaja from " ..
                                ply:Name() .. "! They now have " ..
                                targetBuffsTable["Tarukaja_Inugami"].stacks ..
                                " stacks!"
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        local message = target:Name() .. " received Tarukaja! They now have " ..
                            targetBuffsTable["Tarukaja_Inugami"].stacks ..
                            " stacks!"
