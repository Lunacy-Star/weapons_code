...
SWEP.PrintName = "Electric Guitar (Assault)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Flicking with tooth! Burning in the fire! And beat people with it! That's how guitar is used! Yeeeeeeeeeeeeeeeeah!! Secondary fire deals 30 + DEX single target Elec damage with 15 Technique. The single-target attack has a Shock chance of 5%. If the attack lands, immediately follow up with an unavoidable 10 Elec damage to entire enemy party. \n[DEX 4] Restore 3 MP after this weapon is used."
SWEP.Instructions = ""
