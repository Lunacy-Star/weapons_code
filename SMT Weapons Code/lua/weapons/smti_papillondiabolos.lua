...
SWEP.PrintName = "Papillon Diabolos"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "An axe that glitters from the magic within, with a blade shaped like the wings of a butterfly. Energy scatters off the blade like butterfly scales, vitalizing the area around it. Outgoing healing from skills increased by 20 HP."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_papillondiaolos.png"
...
SWEP.BuffType = "buffs"
SWEP.BuffName = "Papillon_Diabolos"
