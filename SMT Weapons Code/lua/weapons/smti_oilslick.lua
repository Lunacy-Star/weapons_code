...
SWEP.PrintName = "Oil Slick"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A glove capable of conjuring compacted acidic oil. Just touching it feels dangerous in itself. Killing a target with Oil Slick restores 15 MP. \n[DEX 5] Restoration effect is 22 MP instead."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if newHP <= 0 then
                ...
                if playerDex >= 5 then recoverMP = 22 end

                local newMP = math.min(currentMP + recoverMP, maxMP)

                targetEffects["ply"]:ChatPrint(
                    "You recover " .. recoverMP .. " MP due to Oil Slick!");
