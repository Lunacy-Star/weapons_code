...
SWEP.PrintName = "Stun Needle"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 45 gun damage on a single target. 26% chance to inflict Paralysis on hit. \n[STR 3 + DEX 4] HP Cost reduced to 10 HP [CHR 5] 34% chance to inflict Paralysis on hit."
SWEP.Instructions = ""
