...
SWEP.PrintName = "Thunder Reign"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Caster deals 50 elec damage to self but gains +1 Sukukaja after the attack and deals 130% of the damage they received on all enemy targets. \n[DEX 7]  Gains +1 Tarukaja and +1 Sukukaja instead."
SWEP.Instructions = ""
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            self:AnnounceMessage(ply:Name() ..
                                     " received 1 Sukukaja stack! They now have " ..
            ...
            if playerDex >= 7 then
                ...
                self:AnnounceMessage(ply:Name() ..
                                         " received 1 Tarukaja stack! They now have " ..
