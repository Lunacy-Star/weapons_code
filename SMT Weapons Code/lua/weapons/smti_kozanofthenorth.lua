...
SWEP.PrintName = "Kozan of the North"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A set of tonfa handed to only those who have trained at the North Mountain, one of five mountain training grounds. Those who wield them will find spiritual powers bubbling out of them like a stream. Deal additional damage based on 14% of Max SP. \n[STR 6] Additional damage from 16% of Max SP. \n[DEX 6] Technique 20. \n[CHR 6] Base damage increased to 25."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerChr >= 6 then targetEffects["baseDamage"] = 25 end
            ...
            local maxMPPercentage = 0.14
            local playerStr = tonumber(ply:GetNWInt("TBCSTR", 0))
            if playerStr >= 6 then maxMPPercentage = 0.16 end
