...
SWEP.PrintName = "Critical Eye (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Buffs the bonus crit rate of an ally by 20%+ for 3 turns."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Critical_Eye"] = {stacks = 1, duration = 3}

            AssignStat(target, "Critical_Eye", targetBuffsTable["Critical_Eye"],
                       "buffs")
