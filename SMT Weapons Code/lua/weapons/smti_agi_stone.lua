...
SWEP.PrintName = "Agi Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone containing compressed magic power of an affinity. Ammo Stack = 3. Deals 30 single-target damage based on the type of affinity in the name of the stone. Has no special effects."
SWEP.Instructions = ""
