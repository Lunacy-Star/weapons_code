...
SWEP.PrintName = "Fastball"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 34 throw damage on a single target. Bonus Crit Chance 10%+ [CHR 4] 10%+ more damage on Critical Strike [DEX 4] 25 Technique"
SWEP.Instructions = ""
