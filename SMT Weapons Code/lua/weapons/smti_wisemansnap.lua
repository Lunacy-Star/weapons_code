...
SWEP.PrintName = "Wiseman Snap"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 66 throw damage (all enemies). \n[STR 6] HP Cost reduced to 22 HP. \n[DEX 6] Technique +3 [CHR 6] Bonus Crit Chance +5%"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerStr >= 6 then hpCost = 22 end
        ...
        if playerDex >= 6 then tech = 3 end
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if playerChr >= 6 then critBonus = critBonus + 5 end
