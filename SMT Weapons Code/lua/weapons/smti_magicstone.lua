...
SWEP.PrintName = "Magic Stone"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A stone that recovers a target's health and mana. Ammo Stack = 4. Effect: Target is healed for 50 HP and recovers 40 MP."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local newMP = math.min(currentMP + 40, maxMP)

            target:SetNWInt("TBCMP", newMP)

            local message = target:Name() .. " received " ..
                                targetEffects["baseDamage"] ..
                                " healing and 40 MP from " .. ply:Name() .. "!"
            if inAFight then
                ...
                message = target:Name() .. " received " ..
                              ...
                              " healing and 40 MP!"
                ply:ChatPrint(message)
                message = ply:Name() .. " gave you 40 MP and healed you for " ..
                              targetEffects["baseDamage"] .. "!"
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        if inAFight then
            ...
            message = target:Name() .. " received " ..
                          targetEffects["baseDamage"] .. " healing and 40 MP!"
            ply:ChatPrint(message)
        end
        self:TakePrimaryAmmo(1)
