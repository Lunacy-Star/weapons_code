...
SWEP.PrintName = "Bolt Storm"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Hits 3-5 times on random foes. 26 elec damage for the first hit, but every subsequent hit deals 5 less damage than the last. \n[DEX 6] 28 elec damage for first hit instead. \n[STR 6] Every subsequent hit deals 4 less damage instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            if playerDex >= 5 then self.DamageAmount = 28 end

            local lowerDamage = 5
            if playerStr >= 5 then lowerDamage = 4 end
