...
SWEP.PrintName = "Wolf Fang Club"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "The weapon used by Qin Ming, one of the characters in the Ming Dynasty novel Water Margin. +1 Luck."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_wolffangclub.png"
...
SWEP.ViewModel = "models/weapons/smti_blunt1_v.mdl" -- Viewmodel path
