...
SWEP.PrintName = "Matarukaja"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Tarukaja +1 to all allies. Every Tarukaja increases damage dealt by 0.1x. Maximum Tarukaja count = 4."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                ...
                local message = player:Name() .. " received Tarukaja from " ..
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                if IsValid(player) then -- Check if the player is valid
                    ...
                    AssignStat(player, "Tarukaja", buffsTable["Tarukaja"],
                               "buffs")
                    ...
                    local message =
                        player:Name() .. " received Tarukaja from " ..
                            ply:Name() .. "! They now have " ..
