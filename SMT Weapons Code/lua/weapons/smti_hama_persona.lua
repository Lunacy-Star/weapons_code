...
SWEP.PrintName = "Hama (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "60 light damage to a single target. The following conditions trigger instakill based on percent value and add onto each other: Marked with Judgement: 3% [CHR 6] Marked with Judgement chance is 4% instead."
SWEP.Instructions = ""
