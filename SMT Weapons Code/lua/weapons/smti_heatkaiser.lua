...
SWEP.PrintName = "Heat Kaiser"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Hits 2-4 times on random foes. 22 nuke damage for each hit. If hitting an enemy inflicted by Burn/Freeze/Shock/Confusion, 15% bonus crit chance. \n[CHR 5] Maximum potential hit count increases to 5. \n[DEX 5] Bonus crit chance effect is 20% instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            local maxHits = 4
            if playerChr >= 5 then maxHits = 5 end
