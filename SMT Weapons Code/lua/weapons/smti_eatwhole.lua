...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 6 then targetEffects["baseDamage"] = 40 end
            ...
            if playerChr >= 6 then
                targetEffects["baseDamage"] = targetEffects["baseDamage"] + 5
            end

            attackerNewHP = math.min(currentHP + targetEffects["baseDamage"],
                                     maxHP)

            targetEffects["ply"]:SetNWInt("TBCHP", attackerNewHP)
