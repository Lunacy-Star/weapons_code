...
SWEP.PrintName = "Tetraja Break"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Removes Tetraja from target if applicable."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if buffsTable["Tetraja"] then
                RemoveStat(target, "Tetraja", "buffs")
                buffsTable["Tetraja"] = nil
                message = target:Name() .. "'s Tetraja is broken apart!"
            end
