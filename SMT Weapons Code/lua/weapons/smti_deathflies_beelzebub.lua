...
SWEP.PrintName = "Death Flies (Beelzebub)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Causes pestilence itself to engulf the enemy party. Deals 95 almighty damage to all enemies and has a 10% chance of instantly killing any target weak to Dark. Marks hit targets with Cursed."
SWEP.Instructions = ""
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                if SERVER and IsValid(target) then
                    ...
                    if 100 <= targetEffects["ailmentChance"] then
                        ...
                        if not debuffsTable["Cursed"] then
