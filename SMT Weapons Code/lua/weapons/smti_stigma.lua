...
SWEP.PrintName = "Stigma"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deals 55 Blade Damage. +10 Technique. \n[STR 4] Deals 60 Blade Damage. \n[DEX 4] +15 Technique. \n[CHR 4] +3 Luck."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_stigma.png"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            local tech = 5
            if playerDex >= 4 then tech = 15 end
            ...
            if playerStr >= 4 then targetEffects["baseDamage"] = 60 end
...
function SWEP:Deploy()
    if SERVER then
        ...
        if playerChr >= 4 and not self.LuckModified then
            ...
            self.Owner:SetNWInt("TBCLuck", playerLuck + 3)
