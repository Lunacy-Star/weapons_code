...
SWEP.PrintName = "Stardrop"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 20 martial art damage on a single target. Lowers target's Tarukaja by -1. \n[STR 5] HP Cost reduced to 10 HP. \n[DEX 5] Technique 25."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            AssignStat(targetEffects["target"], "Tarunda",
