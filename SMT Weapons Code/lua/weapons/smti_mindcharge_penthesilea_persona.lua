...
SWEP.PrintName = "Mind Charge (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Increases next magic attack's damage by 1.6x. Includes damage increased through Tarukaja."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Mind_Charge_Penthesilea"] = {stacks = 1}

            AssignStat(target, "Mind_Charge_Penthesilea",
                       targetBuffsTable["Mind_Charge_Penthesilea"], "buffs")
