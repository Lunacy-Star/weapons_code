...
SWEP.Contact = ""
SWEP.Purpose =
    "Caster deals 50 force damage to self but gains +1 Sukukaja after the attack and deals 130% of the damage they received on all enemy targets. \n[DEX 7] Gains +2 Sukukaja instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            local buffStacks = 1
            if playerDex >= 7 then buffStacks = 2 end
            ...
            if userBuffsTable["Sukukaja"] then
                ...
                userBuffsTable["Sukukaja"] = {stacks = buffStacks}
            end
