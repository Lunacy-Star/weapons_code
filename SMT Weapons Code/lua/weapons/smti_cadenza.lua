...
SWEP.PrintName = "Cadenza"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Restores HP of all allies by 35% of their Max HP. Gives Sukukaja +1 and Lydia to all allies."
SWEP.Instructions = ""
                ...
                for _, target in ipairs(playersInFight) do
                    if IsValid(target) then -- Check if the player is valid
                        ...
                        if currentHP > 0 then
                            ...
                            targetEffects["percentHeal"] = 0.35
                            ...
                            AssignStat(target, "Sukukaja",
                                       targetBuffsTable["Sukukaja"], "buffs")
                            ...
                            local message =
                                target:Name() .. " received " ..
                                    ...
                                    " and now has Lydia and Sukukaja!"
