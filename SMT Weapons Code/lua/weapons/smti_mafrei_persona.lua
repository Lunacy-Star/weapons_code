...
SWEP.PrintName = "Mafrei (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "32 nuke damage (all enemies). [STR 3 + DEX 3] If hitting an enemy inflicted by Burn, Freeze, Shock, or Confusion, Bonus Crit Chance 20%+."
SWEP.Instructions = ""
