...
SWEP.PrintName = "Antikythera (Figue)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Figue's COMP serves as both a Gun-type weapon that deals 45 Gun-type damage. \n[STR 4] 50 Damage [DEX 4] 20+ Technique [CHR 4] Casting Analysis recovers 2 MP."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 4 then totalTech = 20 end
            ...
            if playerStr >= 4 then targetEffects["baseDamage"] = 50 end
