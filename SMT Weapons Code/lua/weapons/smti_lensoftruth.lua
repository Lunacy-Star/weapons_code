...
SWEP.PrintName = "Lens of Truth"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "Gives Tarukaja +1, Rakukaja +1 and Heal Boost to all allies."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                ...
                buffsTable["Heal_Boost"] = {stacks = 1}
                ...
                local message = player:Name() ..
                                    " received Heal Boost, Tarukaja and Rakukaja from " ..
                ...
                if ply ~= player then lastPlayer = player end
