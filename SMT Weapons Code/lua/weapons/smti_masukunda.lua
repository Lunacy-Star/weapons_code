...
SWEP.PrintName = "Masukunda"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Sukunda +1 to all enemies. Every Sukunda decreases damage dealt by 0.1x. Maximum Sukunda count = 4."
SWEP.Instructions = ""
