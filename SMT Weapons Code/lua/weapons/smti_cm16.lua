...
SWEP.PrintName = "C-M16"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Assault rifle that has been a favorite over a long time in many countries. Performance and colors are customized for urban warfare. Every Tarukaja on the wielder buffs the damage by 5."
SWEP.Instructions = ""
        ...
        if SERVER and IsValid(target) then
            ...
            if userBuffsTable["Tarukaja"] then
                targetEffects["baseDamage"] =
                    targetEffects["baseDamage"] +
                        (5 * userBuffsTable["Tarukaja"]["stacks"])
            end
