...
SWEP.PrintName = "This is my gun"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Ash fires a 12-Gauge Double-Barreled Remington, dealing 80 Gun damage on a single target. If the enemy is holding a Blade-type skill or weapon, deal 90 Gun damage instead. Has Pierce effect."
SWEP.Instructions = ""
SWEP.Category = "Ash Ranged Skills"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if self:AbilityRollNumber(0, tr.Entity) then
                ...
                if IsValid(weapon) then
                    if weapon.Affinity == "Blade" then
                        targetEffects["baseDamage"] = 90
                    end
                end
