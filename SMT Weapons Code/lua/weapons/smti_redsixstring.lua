...
SWEP.PrintName = "Red Six-String"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A guitar imbued with magic properties. It also has some modifications to make it sturdier against battle damage. Secondary fire deals 35 + STR single target Fire damage with 10 Technique. \n[STR 5] Secondary fire attack now has a Burn chance of 5%."
SWEP.Instructions = ""
