...
SWEP.PrintName = "Auto-Repair (Soul Hack)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "When Auto-Repair is cast, heal all party members by 25 HP. For all party members, their next 2 turns will heal them by 25 HP at the start. Cannot be dispelled. When cast outside of combat, it heals everyone in a radius around Figue instantly for 60 HP."
SWEP.Instructions = ""
                ...
                for _, target in ipairs(playersInFight) do
                    if IsValid(target) then -- Check if the player is valid
                        ...
                        if currentHP > 0 then
                            ...
                            AssignStat(target, "Auto_Repair",
                                       targetBuffsTable["Auto_Repair"], "buffs")

                            local message =
                                target:Name() .. " received " ..
                                    targetEffects["baseDamage"] ..
                                    " healing from " .. ply:Name() ..
                                    " and now Auto Repairs!"
