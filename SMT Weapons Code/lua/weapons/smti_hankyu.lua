...
SWEP.PrintName = "Hankyū"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A shortbow often used by Kyūdō practitioners. They were once an essential weapon during Feudal Japan. Every Sukukaja increases the damage of this weapon by 6."
SWEP.Instructions = ""
        ...
        if SERVER and IsValid(target) then
            ...
            if userBuffsTable["Sukukaja"] then
                targetEffects["baseDamage"] =
                    targetEffects["baseDamage"] +
                        (6 * userBuffsTable["Sukukaja"]["stacks"])
            end
