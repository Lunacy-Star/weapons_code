...
SWEP.PrintName = "Royal Scepter of Demonic Blood"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A combat rod adorned with gems formed from crystallizing the blood of a royal demon. Its magical nature greatly enhances the wielder's magic powers. Curative spells from wielder heal additional +20 HP."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_royalscepterofdemonicblood.png"
...
SWEP.BuffType = "buffs"
SWEP.BuffName = "Royal_Scepter_of_Demonic_Blood"
