...
SWEP.PrintName = "Unarmed Fists"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "These fists are for fighting."
SWEP.Instructions = ""
...
function SWEP:Initialize() self:SetHoldType("fist") end
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit then
        ...
        self:EmitSound(Sound("Flesh.ImpactHard"))
    else
