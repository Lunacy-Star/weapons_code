...
SWEP.PrintName = "Elec Wall"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Elec affinity of an ally to Resist. Only works on allies who do not resist or are weak to Elec and lasts against 1 attack. If used on a target who is inflicted by Elec Break, dispel Elec Break and restore their affinity instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetDebuffsTable["Elec_Break"] then
                RemoveStat(target, "Elec_Break", "debuffs")
                targetDebuffsTable["Elec_Break"] = nil
                message = target:Name() .. "'s Elec Break is dispelled!"

            elseif not (table.HasValue(resist, "Elec") or
                (table.HasValue(resist, "Magic") and
                    table.HasValue(Affinities.Magic, "Elec")) or
                (table.HasValue(resist, "Physical") and
                    table.HasValue(Affinities.Physical, "Elec")) or
                table.HasValue(repel, "Elec") or
                (table.HasValue(repel, "Magic") and
                    table.HasValue(Affinities.Magic, "Elec")) or
                (table.HasValue(repel, "Physical") and
                    table.HasValue(Affinities.Physical, "Elec")) or
                table.HasValue(weak, "Elec") or
                (table.HasValue(weak, "Magic") and
                    table.HasValue(Affinities.Magic, "Elec")) or
                (table.HasValue(weak, "Physical") and
                    table.HasValue(Affinities.Physical, "Elec")) or
                table.HasValue(block, "Elec") or
                (table.HasValue(block, "Magic") and
                    table.HasValue(Affinities.Magic, "Elec")) or
                (table.HasValue(block, "Physical") and
                    table.HasValue(Affinities.Physical, "Elec")) or
                table.HasValue(drain, "Elec") or
                (table.HasValue(drain, "Magic") and
                    table.HasValue(Affinities.Magic, "Elec")) or
                (table.HasValue(drain, "Physical") and
                    table.HasValue(Affinities.Physical, "Elec"))) then

                targetBuffsTable["Elec_Wall"] = {stacks = 1}

                AssignStat(target, "Elec_Wall", targetBuffsTable["Elec_Wall"],
                           "buffs")
