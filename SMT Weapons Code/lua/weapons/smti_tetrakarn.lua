...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            targetBuffsTable["Tetrakarn"] = {stacks = 1, duration = 3}

            AssignStat(target, "Tetrakarn", targetBuffsTable["Tetrakarn"],
                       "buffs")
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        targetBuffsTable["Tetrakarn"] = {stacks = 1, duration = 4}

        AssignStat(target, "Tetrakarn", targetBuffsTable["Tetrakarn"], "buffs")
