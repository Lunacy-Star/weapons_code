...
SWEP.PrintName = "Vajra"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "The Heavenly King Komokuten once owned this weapon, a holy artifact said to be represent the Buddha. Heals back 10 HP from damage caused by Light. \n[STR 6] Heals back 15 HP from damage caused by Light. \n[DEX 6] Weapon deals Light damage instead of Blunt. \n[CHR 6] On hit, mark enemy with Judgement."
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_vajra.png"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerChr >= 6 then
                targetEffects["ailment"] = "Judgement"
                ...
                if 100 <= targetEffects["ailmentChance"] then
                    ...
                    debuffsTable["Judgement"] = {stacks = 1, duration = 3}

                    AssignStat(targetEffects["target"], "Judgement",
                               debuffsTable["Judgement"], "debuffs")

                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now Judged!")
                    HandleStatus(targetEffects["ply"], userBuffsTable,
                                 "ailmentReaction", "Judgement", targetEffects)
                end
            end
