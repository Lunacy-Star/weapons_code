...
SWEP.PrintName = "Zandyne"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "80 force damage to a single target. 10% chance to inflict Confusion. \n[DEX 4] MP Cost reduced to 20 MP. \n[CHR 4] 20% chance to inflict Confusion."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 4 then mpCost = 20 end
