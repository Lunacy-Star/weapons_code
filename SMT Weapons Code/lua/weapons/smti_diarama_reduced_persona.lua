...
SWEP.Contact = ""
SWEP.Purpose =
    "Heal based on 40% of target's max base HP. Heal 100 HP instead if Max Base HP <= 250. \n[CHR 4] Heal 120 HP instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if true then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerChr >= 4 then targetEffects["baseDamage"] = 120 end
