...
SWEP.PrintName = "Wakizashi of Fuma"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A short katana named after the Fuma ninja clan that was based in the Soma Ashigara area during the Sengoku period. +5 Luck"
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_wakizashioffuma.png"
...
function SWEP:Equip(ply)
    if SERVER then
        timer.Create(ply:Name() .. self.PrintName, 0.2, 1, function()
            local playerLuck = ply:GetNWInt("TBCLuck", 10)
            ply:SetNWInt("TBCLuck", playerLuck + 5)
        end)
    end
end
