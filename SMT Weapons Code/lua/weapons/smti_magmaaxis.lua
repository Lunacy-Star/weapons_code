...
SWEP.PrintName = "Magma Axis"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Conjures flames on both palms, blasting heat at a single target for 80 Fire damage with Pierce effect. 10% chance to inflict Burn. (Although it has an HP cost, Magma Axis is considered a magic skill.)"
SWEP.Instructions = ""
