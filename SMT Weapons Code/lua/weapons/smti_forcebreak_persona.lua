...
SWEP.PrintName = "Force Break (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Force affinity of a target to Weak. Only works on targets who are not Weak to Force and lasts for 2 turns. Force Break is not considered an ailment but can be dispelled with Force Wall."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if not (table.HasValue(weak, "Force") or
                ...
                targetDebuffsTable["Force_Break"] = {stacks = 1, duration = 2}

                AssignStat(target, "Force_Break",
                           targetDebuffsTable["Force_Break"], "debuffs")
