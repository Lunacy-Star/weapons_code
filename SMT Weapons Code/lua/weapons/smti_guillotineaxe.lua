...
SWEP.PrintName = "Guillotine Axe"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "An executioner's axe. When attacking non-boss enemies with less than 20% of their Max HP, 50% chance to instantly kill them instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if (math.random(1, 100) <= 50) and (maxHP * 0.25) >= currentHP then
