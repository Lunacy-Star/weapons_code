...
SWEP.PrintName = "Mara's Vajra"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A sacred tool of the demon Mara with considerable destructive powers. Its nature could turn saintly or demonic depending on who wields it. Heals back 10 HP from damage caused by Dark. \n[STR 6] Heals back 15 HP from damage caused by Dark. \n[DEX 6] Weapon deals Light damage instead of Blunt. \n[CHR 6] On hit, mark enemy with Cursed."
SWEP.Instructions = ""
            ...
            if playerChr >= 6 then
                if 100 <= targetEffects["ailmentChance"] then
                    ...
                    self:AnnounceMessage(
                        targetEffects["target"]:Name() .. " is now cursed!")
