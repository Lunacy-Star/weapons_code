...
SWEP.PrintName = "Schiavona"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "The familiar broadsword carried by the Venetian Guard, with a beautiful knuckle guard with a cage-like design. Auto-Rakukaja (Start every battle with 1 Rakukaja)"
SWEP.Instructions = ""
SWEP.Category = "SMT Physical Melee Weapons"
SWEP.SpawnMenuIcon = "materials/entities/smti_shiavona.png"
...
SWEP.BuffType = "buffs"
SWEP.BuffName = "Rakukaja"
SWEP.BuffStructure = {stacks = 1}
