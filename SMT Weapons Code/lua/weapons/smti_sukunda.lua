...
SWEP.PrintName = "Sukunda"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Decreases Sukukaja count by -1. Every Sukunda decreases Technique by 10. Minimum Sukukaja count = -4."
SWEP.Instructions = ""
SWEP.Category = "SMT Support Skills"
SWEP.SpawnMenuIcon = "materials/entities/smti_sukunda.png"
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        local message = target:Name() .. " received " .. self.PrintName ..
                            "! They now have " ..
                            targetDebuffsTable["Sukunda"].stacks .. " stacks!"
