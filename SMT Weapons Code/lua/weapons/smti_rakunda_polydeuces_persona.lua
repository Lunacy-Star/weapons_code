...
SWEP.PrintName = "Rakunda (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Decreases Rakukaja count by -1. Every Rakunda increases received damage by 0.2x. Minimum Rakukaja count = -4."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"] then
                targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"].stacks =
                    math.min(
                        targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"]
                            .stacks + 1, 4)
            else
                targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"] =
                    {stacks = 1}
            ...
            AssignStat(target, "Rakunda_Polydeuces",
                       targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"],
                       "debuffs")
            ...
            local message =
                target:Name() .. " received Rakunda! They now have " ..
                    targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"]
                        .stacks .. " stacks!"
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and IsValid(target) then
        ...
        local message = target:Name() .. " received Rakunda! They now have " ..
                            targetEffects["targetDebuffsTable"]["Rakunda_Polydeuces"]
                                .stacks .. " stacks!"
