...
SWEP.PrintName = "Fire of Sinai (Metatron)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Fires holy light from the user's eyes onto the ground beneath the enemy party. Hits 3-5 times on random enemies. Each hit deals 30 almighty damage. Marks hit targets with Judgement."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if next(targetedTargets) == nil then
            ...
            local loopIterations = math.random(3, 5)
