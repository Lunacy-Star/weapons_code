...
SWEP.PrintName = "Zero Set (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose = "All other party member's next turn have SP costs reduced to 0."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                ...
                buffsTable["Zero_Set"] = {stacks = 1}

                AssignStat(player, "Zero_Set", buffsTable["Zero_Set"], "buffs")

                local message = player:Name() .. " received Zero Set from " ..
                                    ply:Name() .. "!"
