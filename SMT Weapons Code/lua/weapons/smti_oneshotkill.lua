...
SWEP.PrintName = "One-Shot Kill"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 77 gun damage on a single target with 20%+ Bonus Crit Chance. \n[DEX 6] HP Cost reduced to 22."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 6 then hpCost = 22 end
