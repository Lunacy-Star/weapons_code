...
SWEP.PrintName = "Swift Kicks"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 28 martial art damage (all enemies). \n[STR 6] 30 martial art damage [DEX 6] 18 Technique."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerDex >= 6 then tech = 18 end
