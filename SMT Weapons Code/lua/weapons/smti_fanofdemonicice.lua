...
SWEP.PrintName = "Fan of Demonic Ice"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A fan cleansed with the spiritual waters of Mount Penglai that has the power to ward off unholy presences. Heals back 10 HP from damage caused by Ice. \n[STR 6] Weapon damage is calculated as Ice instead of Blade. \n[CHR 6] Regeneration effect increased to 15 HP, and additionally regenerates 2 MP."
SWEP.Instructions = ""
...
SWEP.BuffType = "buffs"
SWEP.BuffName = "Fan_of_Demonic_Ice"
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if not self:AbilityRollNumber(20, target) then
                ply:LagCompensation(false)
                return
            end
