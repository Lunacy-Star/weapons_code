...
SWEP.PrintName = "Masukukaja"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Sukukaja +1 to all allies. Every Sukukaja increases damage dealt by 0.1x. Maximum Sukukaja count = 4."
SWEP.Instructions = ""
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            for _, player in ipairs(playersInFight) do
                ...
                local message = player:Name() .. " received Sukukaja from " ..
