...
SWEP.PrintName = "Mafreidyne"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "72 nuke damage (all enemies). If hitting an enemy inflicted by Burn/Freeze/Shock/Confusion, 20% bonus crit chance. \n[CHR 4] MP Cost reduced to 32 MP. \n[DEX 4] Bonus crit chance effect is 25% instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerChr >= 4 then mpCost = 32 end
