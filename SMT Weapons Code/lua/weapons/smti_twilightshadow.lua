...
SWEP.PrintName = "Twilight Shadow"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Heal self for +25 HP and +1 Tarukaja to a targeted ally (Primary Fire), or heal ally for +25 HP and receive +1 Tarukaja for self (Secondary Fire)."
SWEP.Instructions = ""
