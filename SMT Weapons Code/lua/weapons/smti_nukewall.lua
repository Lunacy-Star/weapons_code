...
SWEP.PrintName = "Nuke Wall"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Changes Nuke affinity of an ally to Resist. Only works on allies who do not resist or are weak to Nuke and lasts against 1 attack. If used on a target who is inflicted by Nuke Break, dispel Nuke Break and restore their affinity instead."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetDebuffsTable["Nuke_Break"] then
                RemoveStat(target, "Nuke_Break", "debuffs")
                targetDebuffsTable["Nuke_Break"] = nil
                message = target:Name() .. "'s Nuke Break is dispelled!"

            elseif not (table.HasValue(resist, "Nuke") or
                (table.HasValue(resist, "Magic") and
                    table.HasValue(Affinities.Magic, "Nuke")) or
                (table.HasValue(resist, "Physical") and
                    table.HasValue(Affinities.Physical, "Nuke")) or
                table.HasValue(repel, "Nuke") or
                (table.HasValue(repel, "Magic") and
                    table.HasValue(Affinities.Magic, "Nuke")) or
                (table.HasValue(repel, "Physical") and
                    table.HasValue(Affinities.Physical, "Nuke")) or
                table.HasValue(weak, "Nuke") or
                (table.HasValue(weak, "Magic") and
                    table.HasValue(Affinities.Magic, "Nuke")) or
                (table.HasValue(weak, "Physical") and
                    table.HasValue(Affinities.Physical, "Nuke")) or
                table.HasValue(block, "Nuke") or
                (table.HasValue(block, "Magic") and
                    table.HasValue(Affinities.Magic, "Nuke")) or
                (table.HasValue(block, "Physical") and
                    table.HasValue(Affinities.Physical, "Nuke")) or
                table.HasValue(drain, "Nuke") or
                (table.HasValue(drain, "Magic") and
                    table.HasValue(Affinities.Magic, "Nuke")) or
                (table.HasValue(drain, "Physical") and
                    table.HasValue(Affinities.Physical, "Nuke"))) then

                targetBuffsTable["Nuke_Wall"] = {stacks = 1}

                AssignStat(target, "Nuke_Wall", targetBuffsTable["Nuke_Wall"],
                           "buffs")
