...
SWEP.PrintName = "Heat Wave (Persona)"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "Deal 35 physical damage (all enemies). \n[STR 6] HP Cost reduced to 8 HP. \n[DEX 4] Bonus Crit Chance 10%+"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
        ...
        if playerStr >= 6 then hpCost = 8 end
        ...
        if next(targetedTargets) == nil then
            ...
            for _, ent in pairs(targetedTargets) do
                ...
                local critBonus = 0
                if playerDex >= 4 then critBonus = critBonus + 10 end

                critBonus = (HandleStatus(ply, userBuffsTable,
                                          "increaseCritChance",
