...
SWEP.Contact = ""
SWEP.Purpose =
    "A gun of death that feeds on the life of its wielder. Those lacking a strong heart will soon lose their soul and flesh to this weapon. Inflicts 25 true damage to wielder upon every use. \n[STR 4] Effect becomes 35 true damage instead [DEX 4] Technique -30 [CHR 4] -6 Luck. If 2 of the stat effects are active, damage becomes 115."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerStr >= 4 then hpCost = 35 end
            ...
            if not self:AbilityRollNumber(weaponTech, target) then
                ply:LagCompensation(false)
                return
            end
            ...
            if countStats >= 2 then targetEffects["baseDamage"] = 115 end
