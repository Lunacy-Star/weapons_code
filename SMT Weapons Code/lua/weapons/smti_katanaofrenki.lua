...
SWEP.PrintName = "Katana of Renki"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A katana shaped from intense ki of the maker, the purity of which has turned the weapon into a vessel for trapping various magical powers. If target has lower Max MP than user or is a boss-type target, then deal 60 damage instead."
SWEP.Instructions = ""
