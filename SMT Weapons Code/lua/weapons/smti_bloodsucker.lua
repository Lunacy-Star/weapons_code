...
SWEP.Contact = ""
SWEP.Purpose =
    "An axe shrouded in magic powers that absorbs the life of its wielder while making it easier to deliver Critical Hits. Reduce Max HP by 25. Heal 12 HP on hit. Bonus Crit Chance 10%"
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            critBonus = (HandleStatus(ply, userBuffsTable, "increaseCritChance",
            ...
            local newHP = math.min(HPToHeal + 12, maxHP)
            ply:SetNWInt("TBCHP", newHP)
            ply:ChatPrint("You received 12 healing from Bloodsucker!")
