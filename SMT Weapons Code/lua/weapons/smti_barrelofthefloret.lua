...
SWEP.PrintName = "Barrel of the Floret"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "A rifle with an organic form that conjures images of flowers breathing. \n[DEX 6 + CHR 2] When dealing critical damage, inflict Poison."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if playerDex >= 6 and playerChr >= 2 and targetEffects["state"] ==
                "crit" then
