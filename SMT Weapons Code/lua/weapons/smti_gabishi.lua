...
SWEP.PrintName = "Gabishi"
SWEP.Author = "Nara"
SWEP.Contact = ""
SWEP.Purpose =
    "The crescent-moon shape tip of this sword makes it easier to deliver a clean cut to any enemy. +5 Luck"
SWEP.Instructions = ""
...
function SWEP:DropFunction()
    if SERVER and IsValid(self.Owner) then
        ...
        self.Owner:SetNWInt("TBCLuck", playerLuck - 5) -- Ensuring it doesn't go below the default value
    end
end
