...
SWEP.Contact = ""
SWEP.Purpose =
    "A bottle that explodes upon crashing into a target. 10% chance of inflicting Burn. Base damage is 60 against targets that are inflicted with Burn."
SWEP.Instructions = ""
...
function SWEP:PrimaryAttack()
    ...
    if tr.Hit and CheckIfValidTBCEntity(tr.Entity) then
        ...
        if SERVER and IsValid(target) then
            ...
            if targetDebuffsTable["Burn"] then
