...
ENT.PrintName = "Apt Pupil"
ENT.BuffRegistration = "Apt_Pupil"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus Crit Chance 10% for all attacks by user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Apt_Pupil", targetBuffsTable["Apt_Pupil"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_aptpupil")
