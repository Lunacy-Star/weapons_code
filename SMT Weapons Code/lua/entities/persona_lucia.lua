...
ENT.PrintName = "Lucia"
ENT.Description =
    "A Christian martyr who died during the Diocletianic Persecution. She is venerated as the patron saint of the blind. Lucia may also be seen as a figure of illuminating grace, mercy or even justice."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_lucia"] then
    ...
    AssignStat(ply, "persona_lucia", "persona_lucia", "personas")
...
scripted_ents.Register(ENT, "persona_lucia")
