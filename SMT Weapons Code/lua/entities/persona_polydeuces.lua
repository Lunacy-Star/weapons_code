...
ENT.PrintName = "Polydeuces"
ENT.Description =
    "Polydeuces (also known as Pollux) was the younger twin brother of Castor and both were known as the Dioscuri or Hero Twins."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_polydeuces"] then
    ...
    AssignStat(ply, "persona_polydeuces", "persona_polydeuces", "personas")
...
scripted_ents.Register(ENT, "persona_polydeuces")
