...
ENT.PrintName = "Force Boost"
ENT.BuffRegistration = "Force_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Force damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Force_Boost", targetBuffsTable["Force_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_forceboost")
