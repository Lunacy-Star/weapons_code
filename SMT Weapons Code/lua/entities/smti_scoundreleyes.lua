...
ENT.PrintName = "Scoundrel Eyes"
ENT.BuffRegistration = "Scoundrel_Eyes"
ENT.BuffType = "permabuffs"
ENT.Description =
    "Any successful attack made by Yusuke lowers any Sukunda stacks on him by 1 down to 0."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Scoundrel_Eyes"] = {
        stacks = 1,
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Scoundrel_Eyes", targetBuffsTable["Scoundrel_Eyes"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_scoundreleyes")
