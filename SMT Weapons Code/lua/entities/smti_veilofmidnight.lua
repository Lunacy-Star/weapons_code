...
ENT.PrintName = "Veil of Midnight"
ENT.BuffRegistration = "Veil_of_Midnight"
ENT.BuffType = "permabuffs"
ENT.Description =
    "All party members at 40% or below Health do not take extra damage from having their weak point struck."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Veil_of_Midnight"] = {
        stacks = 1,
        targets = "party",
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Veil_of_Midnight",
               targetBuffsTable["Veil_of_Midnight"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_veilofmidnight")
