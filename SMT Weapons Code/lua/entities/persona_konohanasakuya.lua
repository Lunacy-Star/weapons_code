...
ENT.PrintName = "Konohana Sakuya"
ENT.Description =
    "The daughter of the mountain god Ouyamatsumi. When she became Ninigi's wife and grew pregnant on the first night of their marriage, he accused her of infidelity. She stood in a burning hut, claiming that the fire would not touch her if she had been faithful, and emerged unscathed. Her emblem is the cherry blossom."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_konohanasakuya"] then
    ...
    AssignStat(ply, "persona_konohanasakuya", "persona_konohanasakuya",
               "personas")
...
scripted_ents.Register(ENT, "persona_konohanasakuya")
