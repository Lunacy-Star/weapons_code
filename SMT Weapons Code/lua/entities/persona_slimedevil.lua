...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_slimedevil"] then
    ...
    AssignStat(ply, "persona_slimedevil", "persona_slimedevil", "personas")
...
scripted_ents.Register(ENT, "persona_slimedevil")
