...
ENT.PrintName = "Sarasvati"
ENT.Description =
    "The Hindu goddess who embodies the river. Her name means \"one who flows.\" She is also the goddess of music and art and is said to be skilled in every artistic or creative pursuit known to man."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_sarasvati"] then
    ...
    AssignStat(ply, "persona_sarasvati", "persona_sarasvati", "personas")
...
scripted_ents.Register(ENT, "persona_sarasvati")
