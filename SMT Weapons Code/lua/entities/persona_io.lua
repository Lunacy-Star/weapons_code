...
ENT.PrintName = "Io"
ENT.Description = "Io was the priestess to Hera, wife of Zeus, king of the gods."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(ply, "persona_io", "persona_io", "personas")
...
scripted_ents.Register(ENT, "persona_io")
