...
ENT.PrintName = "Kodama"
ENT.Description = "Inside your walls"
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_kodama"] then
    ...
    AssignStat(ply, "persona_kodama", "persona_kodama", "personas")
...
scripted_ents.Register(ENT, "persona_kodama")
