...
ENT.PrintName = "Relaxing Wave"
ENT.BuffRegistration = "Relaxing_Wave"
ENT.BuffType = "permabuffs"
ENT.Description = "Upon winning a fight, the user's party regenerates 15 SP. [CHR 4] The party regenerates 25 SP."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Relaxing_Wave"] = {
        stacks = 1,
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Relaxing_Wave", targetBuffsTable["Relaxing_Wave"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_relaxingwave")
