...
ENT.PrintName = "Fire Boost"
ENT.BuffRegistration = "Fire_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Fire damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Fire_Boost", targetBuffsTable["Fire_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_fireboost")
