...
ENT.PrintName = "Tomoe"
ENT.Description =
    "Was a female samurai during the time of the Genpei War (1180-1185). After fighting in the Battle of Awazu, it is unclear what happened to her."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_tomoe"] then
    ...
    AssignStat(ply, "persona_tomoe", "persona_tomoe", "personas")
...
scripted_ents.Register(ENT, "persona_tomoe")
