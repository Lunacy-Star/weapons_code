...
ENT.PrintName = "Panic Boost"
ENT.BuffRegistration = "Panic_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Increase the bonus chance of inflicting Panic by the user by 10%."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Panic_Boost", targetBuffsTable["Panic_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_panicboost")
