...
ENT.PrintName = "Invigorate"
ENT.BuffRegistration = "Invigorate"
ENT.BuffType = "permabuffs"
ENT.Description = "Recovers 5 MP each turn in battle."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Invigorate", targetBuffsTable["Invigorate"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_invigorate")
