...
ENT.PrintName = "Elec Boost"
ENT.BuffRegistration = "Elec_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Elec damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Elec_Boost", targetBuffsTable["Elec_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_elecboost")
