...
ENT.PrintName = "Regenerate"
ENT.BuffRegistration = "Regenerate"
ENT.BuffType = "permabuffs"
ENT.Description = "Recovers 10 HP each turn in battle."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Regenerate", targetBuffsTable["Regenerate"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_regenerate")
