...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_captainkidd"] then
    ...
    AssignStat(ply, "persona_captainkidd", "persona_captainkidd", "personas")
...
scripted_ents.Register(ENT, "persona_captainkidd")
