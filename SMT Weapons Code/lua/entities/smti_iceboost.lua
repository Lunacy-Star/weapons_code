...
ENT.PrintName = "Ice Boost"
ENT.BuffRegistration = "Ice_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Ice damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Ice_Boost", targetBuffsTable["Ice_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_iceboost")
