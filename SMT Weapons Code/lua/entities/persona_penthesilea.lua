...
ENT.PrintName = "Penthesilea"
ENT.Description =
    "Penthesilea is one of the Amazonian queens that appear in Greek mythology. She is the daughter of Ares, the Greek god of war, and Otrera, queen and founder of the Amazons."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_penthesilea"] then
    ...
    AssignStat(ply, "persona_penthesilea", "persona_penthesilea", "personas")
...
scripted_ents.Register(ENT, "persona_penthesilea")
