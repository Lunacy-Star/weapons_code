...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_agathion"] then
    ...
    AssignStat(ply, "persona_agathion", "persona_agathion", "personas")
...
scripted_ents.Register(ENT, "persona_agathion")
