...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_succubus"] then
    ...
    AssignStat(ply, "persona_succubus", "persona_succubus", "personas")
...
scripted_ents.Register(ENT, "persona_succubus")
