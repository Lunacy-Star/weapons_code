...
ENT.PrintName = "Sabbath"
ENT.BuffRegistration = "Sabbath"
ENT.BuffType = "permabuffs"
ENT.Description =
    "Whenever an enemy is hit by their weakness or receive a critical strike, immediately deal 10 almighty damage to the target hit."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Sabbath",
               targetBuffsTable["Sabbath"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_sabbath")
