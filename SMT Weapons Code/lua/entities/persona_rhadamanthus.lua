...
ENT.PrintName = "Rhadamanthus"
ENT.Description =
    "The son of Zeus and Europa in Greek mythology. He was a wise king of Crete who, after death, became one of the judges of the dead in the Greek underworld, Hades."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_rhadamanthus"] then
    ...
    AssignStat(ply, "persona_rhadamanthus", "persona_rhadamanthus", "personas")
...
scripted_ents.Register(ENT, "persona_rhadamanthus")
