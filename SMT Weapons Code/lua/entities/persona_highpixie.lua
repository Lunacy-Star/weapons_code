...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_highpixie"] then
    ...
    AssignStat(ply, "persona_highpixie", "persona_highpixie", "personas")
...
scripted_ents.Register(ENT, "persona_highpixie")
