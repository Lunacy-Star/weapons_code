...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_inugami"] then
    ...
    AssignStat(ply, "persona_inugami", "persona_inugami", "personas")
...
scripted_ents.Register(ENT, "persona_inugami")
