...
ENT.PrintName = "Light Boost"
ENT.BuffRegistration = "Light_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Light damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Light_Boost", targetBuffsTable["Light_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_lightboost")
