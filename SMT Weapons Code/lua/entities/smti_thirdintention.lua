...
ENT.PrintName = "Third Intention"
ENT.BuffRegistration = "Third_Intention"
ENT.BuffType = "permabuffs"
ENT.Description = "Killing an enemy with a skill recovers 40 SP."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Third_Intention"] = {
        stacks = 1,
        type = "kill",
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Third_Intention",
               targetBuffsTable["Third_Intention"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_thirdintention")
