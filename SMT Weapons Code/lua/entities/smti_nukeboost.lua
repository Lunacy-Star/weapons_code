...
ENT.PrintName = "Nuke Boost"
ENT.BuffRegistration = "Nuke_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Nuke damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Nuke_Boost", targetBuffsTable["Nuke_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_nukeboost")
