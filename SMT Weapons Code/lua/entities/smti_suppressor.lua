...
ENT.BuffRegistration = "Suppressor"
ENT.BuffType = "permabuffs"
ENT.Description =
    "HP Cost abilities cost 0 HP when Shinjiro has less than 30% HP left."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Suppressor",
               targetBuffsTable["Suppressor"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_suppressor")
