...
ENT.PrintName = "Second Serving"
ENT.BuffRegistration = "Second_Serving"
ENT.BuffType = "permabuffs"
ENT.Description =
    "While Vino is present in the team, all allies gain 15% elemental/non-elemental ailment infliction chance against enemies."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Second_Serving"] = {
        stacks = 1,
        targets = "party",
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Second_Serving", targetBuffsTable["Second_Serving"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_secondserving")
