...
ENT.PrintName = "Endure"
ENT.BuffRegistration = "Endure"
ENT.BuffType = "permabuffs"
ENT.Description = "Survive one fatal blow with 1 HP remaining. Can only trigger once and does not reset until respawn."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Endure", targetBuffsTable["Endure"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_endure")
