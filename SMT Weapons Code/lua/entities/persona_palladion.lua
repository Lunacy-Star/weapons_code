...
ENT.PrintName = "Palladion"
ENT.Description =
    "A palladium, or palladion, was an image of great antiquity on which the safety of a city was said to depend that appear in Greek and Roman mythology. The word \"palladium\" has meant anything believed to provide protection or safety, or a safeguard, therefore similar to the word \"aegis.\""
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_palladion"] then
    ...
    AssignStat(ply, "persona_palladion", "persona_palladion", "personas")
...
scripted_ents.Register(ENT, "persona_palladion")
