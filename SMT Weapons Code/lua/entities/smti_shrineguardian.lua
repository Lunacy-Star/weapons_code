...
ENT.PrintName = "Shrine Guardian"
ENT.BuffRegistration = "Shrine_Guardian"
ENT.BuffType = "permabuffs"
ENT.Description =
    "Koromaru cannot equip Ranged weapons. Equipped Melee weapons each raise Koromaru's Luck by 3."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Shrine_Guardian"] = {
        stacks = 1,
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Shrine_Guardian",
               targetBuffsTable["Shrine_Guardian"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_shrineguardian")
