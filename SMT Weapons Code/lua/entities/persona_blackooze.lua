...
ENT.PrintName = "Black Ooze"
ENT.Description =
    "An amoeba-like monster that attacks and eats people. Supposedly, it is actually a demon that failed to take form. It is said that when a Slime's ability to absorb an unknown life force goes out of control, it transforms into a Black Ooze."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_blackooze"] then
    ...
    AssignStat(ply, "persona_blackooze", "persona_blackooze", "personas")
...
scripted_ents.Register(ENT, "persona_blackooze")
