...
ENT.Description =
    "Nemesis was the ancient Greek goddess of divine retribution against those who succumb to pride and arrogance. She is the daughter of Erebus and Nyx."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_nemesis"] then
    ...
    AssignStat(ply, "persona_nemesis", "persona_nemesis", "personas")
...
scripted_ents.Register(ENT, "persona_nemesis")
