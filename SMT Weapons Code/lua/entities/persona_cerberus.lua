...
ENT.Description =
    "The guardian hound of Hades in Greek lore. It traditionally has three heads and a snake's tail. It was born from Typhon, the giant of wind, and Echidna, the mother of monsters, and is also the older brother of Orthrus."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_cerberus"] then
    ...
    AssignStat(ply, "persona_cerberus", "persona_cerberus", "personas")
...
scripted_ents.Register(ENT, "persona_cerberus")
