...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_jiraiya"] then
    ...
    AssignStat(ply, "persona_jiraiya", "persona_jiraiya", "personas")
...
scripted_ents.Register(ENT, "persona_jiraiya")
