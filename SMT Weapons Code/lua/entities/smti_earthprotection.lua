...
ENT.PrintName = "Earth Protection"
ENT.BuffRegistration = "Earth_Protection"
ENT.BuffType = "permabuffs"
ENT.Description = "After your first action of each turn, heal all allies for 15 HP."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    targetBuffsTable["Earth_Protection"] = {
        stacks = 1,
        SlotsTaking = 1,
        SlotType = "Equipment",
    ...
    AssignStat(activator, "Earth_Protection",
               targetBuffsTable["Earth_Protection"], "permabuffs")
...
scripted_ents.Register(ENT, "smti_earthprotection")
