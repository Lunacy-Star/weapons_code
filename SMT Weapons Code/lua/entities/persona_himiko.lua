...
ENT.PrintName = "Himiko"
ENT.Description =
    "An obscure shaman queen of Yamataikoku, an ancient country within the islands that would become Japan. Her skills in magic and sorcery were highly respected by her people."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_himiko"] then
    ...
    AssignStat(ply, "persona_himiko", "persona_himiko", "personas")
...
scripted_ents.Register(ENT, "persona_himiko")
