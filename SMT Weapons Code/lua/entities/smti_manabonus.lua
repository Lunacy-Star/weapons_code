...
ENT.PrintName = "Mana Bonus"
ENT.BuffRegistration = "Mana_Bonus"
ENT.BuffType = "permabuffs"
ENT.Description = "Increase Max MP by 50 while active."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Mana_Bonus", targetBuffsTable["Mana_Bonus"],
               "permabuffs")

    ApplyStatBoostBuff(activator, targetBuffsTable["Mana_Bonus"])
...
scripted_ents.Register(ENT, "smti_manabonus")
