...
ENT.PrintName = "Pinch Anchor"
ENT.BuffRegistration = "Pinch_Anchor"
ENT.BuffType = "permabuffs"
ENT.Description =
    "When Joker is involved with a combat engagement, his Technique for the Engage calculation will be 75 instead."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Pinch_Anchor", targetBuffsTable["Pinch_Anchor"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_pinchanchor")
