...
ENT.PrintName = "Ruin Boost"
ENT.BuffRegistration = "Ruin_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Ruin damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Ruin_Boost", targetBuffsTable["Ruin_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_ruinboost")
