...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_orpheusf"] then
    ...
    AssignStat(ply, "persona_orpheusf", "persona_orpheusf", "personas")
...
scripted_ents.Register(ENT, "persona_orpheusf")
