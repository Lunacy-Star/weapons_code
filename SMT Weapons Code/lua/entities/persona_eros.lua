...
ENT.PrintName = "Eros"
ENT.Description =
    "Eros is the mischievous god of love and desire in the ancient Greece and the counterpart of the Roman god, Cupid. According to Hesiod's Theogony, Eros was the fourth god to come into existence, coming after Chaos, Gaia, and Tartarus."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(ply, "persona_eros", "persona_eros", "personas")
...
scripted_ents.Register(ENT, "persona_eros")
