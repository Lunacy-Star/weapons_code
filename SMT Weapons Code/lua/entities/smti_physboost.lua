...
ENT.PrintName = "Phys Boost"
ENT.BuffRegistration = "Phys_Boost"
ENT.BuffType = "permabuffs"
ENT.Description = "Bonus +10 damage to all Physical damage from user."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Phys_Boost", targetBuffsTable["Phys_Boost"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_physboost")
