...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_jackolantern"] then
    ...
    AssignStat(ply, "persona_jackolantern", "persona_jackolantern", "personas")
...
scripted_ents.Register(ENT, "persona_jackolantern")
