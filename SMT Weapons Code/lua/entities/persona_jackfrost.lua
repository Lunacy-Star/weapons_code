...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_jackfrost"] then
    ...
    AssignStat(ply, "persona_jackfrost", "persona_jackfrost", "personas")
...
scripted_ents.Register(ENT, "persona_jackfrost")
