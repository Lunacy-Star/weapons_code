...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_chatterskull"] then
    ...
    AssignStat(ply, "persona_chatterskull", "persona_chatterskull", "personas")
...
scripted_ents.Register(ENT, "persona_chatterskull")
