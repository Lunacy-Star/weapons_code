...
ENT.PrintName = "Benevolence"
ENT.BuffRegistration = "Benevolence"
ENT.BuffType = "permabuffs"
ENT.Description =
    "If Marian heals a target and they reach max HP or are already at Max HP, the target gains +1 Tarukaja."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    AssignStat(activator, "Benevolence", targetBuffsTable["Benevolence"],
               "permabuffs")
...
scripted_ents.Register(ENT, "smti_benevolence")
