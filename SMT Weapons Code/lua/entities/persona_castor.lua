...
ENT.PrintName = "Castor"
ENT.Description =
    "Castor was the elder twin brother of Polydeuces and part of the Argonauts. Both Castor and Polydeuces had the same mother, Leda, but Polydeuces' father was Zeus, while Castor's father was a mortal man named Tyndareus."
ENT.Author = "Nara"
...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_castor"] then
    ...
    AssignStat(ply, "persona_castor", "persona_castor", "personas")
...
scripted_ents.Register(ENT, "persona_castor")
