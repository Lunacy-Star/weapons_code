...
function ENT:Use(activator, caller)
    ...
    if personas then
        if personas["persona_sukunahikona"] then
    ...
    AssignStat(ply, "persona_sukunahikona", "persona_sukunahikona", "personas")
...
scripted_ents.Register(ENT, "persona_sukunahikona")
