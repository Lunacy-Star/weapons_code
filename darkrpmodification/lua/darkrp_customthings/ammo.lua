...
DarkRP.createAmmoType("custom_ammo", {
    name = "Custom Ammo", -- Name shown in F4 menu.
    model = "models/Items/BoxSRounds.mdl", -- Model for the ammo box.
    price = 100, -- Price per ammo box.
    amountGiven = 30 -- Amount of ammo given per box.
})
