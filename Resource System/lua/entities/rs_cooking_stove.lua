...
ENT.Description = "A stove for preparing meals and cooking ingredients."
ENT.RequiredProfession = "Cooking"
ENT.ShowInfo = true
ENT.Spawnable = true
ENT.AdminOnly = false
ENT.Model = "models/props_forest/furnace01.mdl"
...
function ENT:Use(activator, caller)
    ...
    if SERVER then
        ...
        net.WriteString(self.RequiredProfession or "Cooking")
        net.WriteTable(knowledge)
        net.Send(activator)
    end
end

scripted_ents.Register(ENT, "rs_cooking_stove")
